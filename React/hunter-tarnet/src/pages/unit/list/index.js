...
export class UnitList extends React.Component {
    ...
    render() {
        axios.get('http://178.128.248.160:81/api/unit', {
            headers: { Authorization: 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1bmlxdWVfbmFtZSI6ImRkNmNhY2IzLTMzNTQtNDUwMC04ODEyLWYwYjQ4NWY4YjRlNCIsImVtYWlsIjoibWdhbmkudG9tYmFsYWtAeWFob28uY29tIiwicm9sZSI6Im51bGwiLCJuYmYiOjE1OTczMjQ4NDQsImV4cCI6MTU5NzMyNTc0NCwiaWF0IjoxNTk3MzI0ODQ0fQ.k8ZWsBDKWG5ekqYjmMHGpztTLuHehLzWjgFIKN00Xdo' }
        })
            .then(response => {
